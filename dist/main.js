...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../images/granular.jpg */ "./src/images/granular.jpg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../images/plus-box-outline.svg */ "./src/images/plus-box-outline.svg"), __webpack_require__.b);
...
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ../images/upload-image.svg */ "./src/images/upload-image.svg"), __webpack_require__.b);
...
const emptyObj = (
    () => {
        ...
        subs = ["earthporn", "TouhouArt", "brutalism", "artporn", "generative"];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "generate_cover": () => (/* binding */ generate_cover)
/* harmony export */ });
/* harmony import */ var _print__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./print */ "./src/generative/print.js");
/* harmony import */ var _chaos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chaos */ "./src/generative/chaos.js");
/* harmony import */ var _packing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./packing */ "./src/generative/packing.js");
/* harmony import */ var _truchet__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./truchet */ "./src/generative/truchet.js");





function generate_cover(width, height) {
    let rnd;

    rnd = ~~(Math.random() * 4);
    switch (rnd) {
        case 0:
            return (0,_print__WEBPACK_IMPORTED_MODULE_0__.ten_print)(width, height);
        case 1: 
            return (0,_chaos__WEBPACK_IMPORTED_MODULE_1__.chaos)(width, height);
        case 2:
            return (0,_packing__WEBPACK_IMPORTED_MODULE_2__.packing)(width, height);
        case 3: 
            return (0,_truchet__WEBPACK_IMPORTED_MODULE_3__.truchet)(200, 200);
    }
}

/***/ }),

/***/ "./src/generative/packing.js":
/*!***********************************!*\
  !*** ./src/generative/packing.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ten_print": () => (/* binding */ ten_print)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "truchet": () => (/* binding */ truchet)
/* harmony export */ });
function truchet(width, height) {
    const canvas = document.createElement("canvas");
    const context = canvas.getContext("2d");
...
/* harmony import */ var _generative_generate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./generative/generate */ "./src/generative/generate.js");
...
function create_project_main_dom(projectObj, extInterface) {
    ...
    imageYes.addEventListener("click", () => {
        if (!newCover)
            newCover = (0,_generative_generate__WEBPACK_IMPORTED_MODULE_3__.generate_cover)(200, 200);
...
/* harmony import */ var _generative_chaos_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./generative/chaos.js */ "./src/generative/chaos.js");
...
createProject.addEventListener("submit", event => {
    ...
    if (!cover)
        cover = (0,_generative_chaos_js__WEBPACK_IMPORTED_MODULE_7__.chaos)(200, 200);
